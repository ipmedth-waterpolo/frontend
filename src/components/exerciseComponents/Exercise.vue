...
<!--    to="/oefening/:id" ofzo voor routing? idk-->
<!--    <v-img-->
<!--      v-if="exercise.afbeeldingen"-->
<!--      :src="JSON.parse(exercise.afbeeldingen).url"-->
<!--      aspect-ratio="16/9"-->
<!--    />-->


<!--    <v-card-subtitle>-->
<!--      Categories: {{ JSON.parse(exercise.categorie).join(", ") }}-->
<!--    </v-card-subtitle>-->


<!--    <v-card-text>-->
<!--      <p><strong>Description:</strong> {{ exercise.omschrijving }}</p>-->
